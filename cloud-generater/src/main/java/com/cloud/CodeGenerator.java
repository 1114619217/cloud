...
//        gc.setSwagger2(true);
        ...
        dsc.setUrl("jdbc:mysql://47.106.135.78:3306/cloud?useUnicode=true&characterEncoding=utf-8&useSSL=false");
        dsc.setDriverName("com.mysql.jdbc.Driver");
        dsc.setUsername("root");
        dsc.setPassword("ku93Yvjelu,");
        ...
        // 自定义实体父类
//        strategy.setSuperEntityClass("model.BaseModel");
        // 自定义controller父类
